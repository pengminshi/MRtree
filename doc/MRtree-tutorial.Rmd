...
#                               nevf=100, n_de_evf=30, sigma=0.7, seed=seed)
...
resolutions = modularity_event_sampling(A=A, n.res=20, gamma.min=0.01, gamma.max=3) # sample based on the similarity matrix
...
out = mrtree(seurat.out$obj, consensus=T, sample.weighted=F)
...
set.seed(1)
clust.out =  sc_clustering.sc3(exprs=counts, Ks=rep(ks, each=clusterings.per.k), type = 'counts', colData=metadata,
